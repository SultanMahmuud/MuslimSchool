...
const PopulerSubjectsModel = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(`${process.env.NEXT_PUBLIC_API_BASE_URL}/populersubjects`, newdata, {
  ...
  return (
    <div className="p-4">
      <h2 className="font-semibold text-xl mb-4 font-[hind]">
        Populer Subjects Model English
      </h2>
...
export default PopulerSubjectsModel;
