...
export default function EditFAQModal({ open, setOpen, singleFaq, triggerEditFaq }) {
  ...
  useEffect(() => {
    ...
    setFaqCategory(singleFaq?.category || "Course");
  }, [singleFaq]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl animate-fadeIn">
        ...
        <div className="bg-blue-600 px-4 py-2 rounded-t-lg">
          <h2 className="text-white font-bold font-sans">Edit FAQ</h2>
        </div>
